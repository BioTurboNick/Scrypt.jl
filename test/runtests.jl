...
@testset "Scrypt Tests" begin
    ...
    @test scrypt(ScryptParameters(1, 16, 1), Vector{UInt8}(b""), 64) == expected[1]
    ...
    @test scrypt_threaded(ScryptParameters(1, 16, 1), Vector{UInt8}(b""), 64) == expected[1]
    ...
    if VERSION >= v"1.9.0"
        ...
        @test scrypt_threaded(ScryptParameters(1, 16, 1), Vector{UInt8}(b""), 64, 0) == expected[1]
    end
